...
public class JoinController {
    ...
    // 로그인 성공시 로그인 여부를 시스템에 저장하기 위해 HttpSession 객체를 이용함
    // 즉, 서버가 생성한 정보를 일정기간 동안 WAS에 저장해두고 필요할 때마다
    // 이것을 활용함으로써 로그인한 사용자를 식별할 수 있음

    @PostMapping("/join/login")
    public String login(Member m, HttpSession sess) {
        String returnPage = "redirect:/join/loginfail"; // 로그인 실패시
