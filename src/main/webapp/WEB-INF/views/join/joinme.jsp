        ...
        <div class="col-11 offset-1">
            ...
            <div class="form-group row">
                ...
                <span class="col-form-label">&nbsp;&nbsp;
                    이전 항목에서 입력했던 비밀번호를 한번 더 입력하세요</span>
            </div><!-- 비밀번호확인 -->
            ...
            <div class="form-group row">
                ...
                <input type="text" name="tel2" id="tel2"
                       class="form-control border-danger col-1" maxlength="4">
                <span class="col-form-label">&nbsp; &mdash; &nbsp; </span>
            ...
            <div class="modal-body">
                <form name="zipfrm" id="zipfrm">
                    <div class="form-inline row justify-content-center">
                        <label class="col-form-label text-primary text-right"
                               for="dong">검색하실 주소의<br> 동 이름을 입력하세요</label>
                        &nbsp;&nbsp;
                    ...
                    <div class="form-group row">
                        ...
                        <p class="col-12 text-danger text-center">
                            지역의 읍/면/동의 이름을 공백없이 입력하신 후 [검색하기] 버튼을 눌러주세요</p>
                        <select class="col-8 offset-2 form-control"
                                size="10" id="addrlist" name="addrlist">
                            <option>123-456 서울 종로구 세종로</option>
                            <option>123-456 서울 종로구 세종로</option>
                            <option>123-456 서울 종로구 세종로</option>
                            <option>123-456 서울 종로구 세종로</option>
                            <option>123-456 서울 종로구 세종로</option>
