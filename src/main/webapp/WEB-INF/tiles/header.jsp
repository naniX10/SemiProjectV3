...
<header class="row">
    <div class="col"><h1><a href="/" style="color: black; text-decoration: none;">
        Lorem Ipsum</a></h1></div>
    <div class="col text-right">
        <c:if test="${empty UID}">
            <h1><button type="button" class="btn btn-danger border-"
                        data-toggle="modal" data-target="#loginmodal">로그인</button>
                <a href="/join/agree"><button type="button" class="btn btn-primary">
                    회원가입</button></a></h1>
        </c:if>
...
<nav class="navbar navbar-expand navbar-dark bg-dark">
    <ul class="navbar-nav nav-fill w-100">
        ...
        <c:if test="${not empty UID}">
            <li class="nav-item">
                <a class="nav-link disabled">회원가입</a> </li>
        </c:if>
